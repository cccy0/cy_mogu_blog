...
import com.github.cccy0.mogublog.xo.mapper.AdminMapper;
import com.github.cccy0.mogublog.xo.service.AdminService;
import com.github.cccy0.mogublog.xo.service.RoleService;
import com.github.cccy0.mogublog.xo.service.SysParamsService;
...
public class AdminServiceImpl extends SuperServiceImpl<AdminMapper, Admin> implements AdminService {
    ...
    public Admin getAdminByUser(String userName) {
        ...
        if (StringUtils.isNotEmpty(admin.getAvatar())) {
            String pictureList = pictureFeignClient.getPicture(admin.getAvatar(), Constants.SYMBOL_COMMA);
