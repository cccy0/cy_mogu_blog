package com.github.cccy0.mogublog.xo.utils;
...
import com.github.cccy0.mogublog.utils.RedisUtil;
import com.github.cccy0.mogublog.xo.global.MessageConf;
import com.github.cccy0.mogublog.xo.global.RedisConf;
import com.github.cccy0.mogublog.xo.global.SQLConf;
import com.github.cccy0.mogublog.xo.global.SysConf;
import com.github.cccy0.mogublog.xo.service.SystemConfigService;
...
public class WebUtil {
                ...
                if (picData.size() > 0) {
                    for (Map<String, Object> picDatum : picData) {
                        ...
                        if (EFilePriority.QI_NIU.equals(picturePriority)) {
                            picUrls.add(qiNiuPictureBaseUrl + picDatum.get(SysConf.QI_NIU_URL));
                        } else if (EFilePriority.MINIO.equals(picturePriority)) {
                            picUrls.add(minioPictureBaseUrl + picDatum.get(SysConf.MINIO_URL));
                        } else {
                            picUrls.add(localPictureBaseUrl + picDatum.get(SysConf.URL));
                        }
                    }
                }
            }
    ...
    public <T> T getData(String result, Class<T> beanType) {
        if (com.github.cccy0.mogublog.utils.StringUtils.isEmpty(result)) {
            return null;
        }
