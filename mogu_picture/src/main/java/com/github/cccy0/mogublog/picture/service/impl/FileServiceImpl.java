package com.github.cccy0.mogublog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.github.cccy0.mogublog.commons.entity.File;
import com.github.cccy0.mogublog.commons.entity.FileSort;
import com.github.cccy0.mogublog.commons.entity.SystemConfig;
import com.github.cccy0.mogublog.picture.global.MessageConf;
import com.github.cccy0.mogublog.picture.global.SQLConf;
import com.github.cccy0.mogublog.picture.global.SysConf;
import com.github.cccy0.mogublog.picture.mapper.FileMapper;
import com.github.cccy0.mogublog.picture.service.*;
import com.github.cccy0.mogublog.picture.util.AboutFileUtil;
import com.github.cccy0.mogublog.picture.util.FeignUtil;
import com.github.cccy0.mogublog.utils.FileUtils;
import com.github.cccy0.mogublog.utils.JsonUtils;
import com.github.cccy0.mogublog.utils.ResultUtil;
import com.github.cccy0.mogublog.utils.StringUtils;
import com.github.cccy0.mogublog.base.enums.EFilePriority;
import com.github.cccy0.mogublog.base.enums.EOpenStatus;
import com.github.cccy0.mogublog.base.enums.EStatus;
import com.github.cccy0.mogublog.base.exception.exceptionType.InsertException;
import com.github.cccy0.mogublog.base.global.Constants;
import com.github.cccy0.mogublog.base.global.ErrorCode;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.github.cccy0.mogublog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.github.cccy0.mogublog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.github.cccy0.mogublog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.github.cccy0.mogublog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.github.cccy0.mogublog.commons.entity.File file = new com.github.cccy0.mogublog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
